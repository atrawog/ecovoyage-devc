...
ulimit_arg = "--ulimit nofile=1048576:1048576"
...
def build_and_tag_docker_image(build_number):
    ...
    build_command = f"docker build {ulimit_arg} -f {dockerfile_path} {docker_build_args} {cache_from_args} -t {image_tag} {docker_context}"
